...
const divTodoList   = document.querySelector('.todo-list'),
      ...
      anchorFlitros = document.querySelectorAll('.filtro'),
...
btnBorrar.addEventListener('click', () =>{
    ...
    //For inverso ya que si lo hago de una manera "Normal"
    //Puede que al cambiar los indices no borre el que yo desee
...
ulFiltors.addEventListener('click', (event) =>{
    ...
    anchorFlitros.forEach(elem => elem.classList.remove('selected'));
